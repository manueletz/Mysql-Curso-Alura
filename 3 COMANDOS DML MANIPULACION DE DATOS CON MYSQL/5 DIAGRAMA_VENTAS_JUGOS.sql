...
CREATE TABLE IF NOT EXISTS `ventas_jugos`.`tb_factura` (
  ...
  PRIMARY KEY (`NUMERO`),
  INDEX `FK_CLIENTE` (`DNI` ASC),
  INDEX `FK_VENDEDOR` (`MATRICULA` ASC),
  CONSTRAINT `FK_CLIENTE`
    FOREIGN KEY (`DNI`)
    REFERENCES `ventas_jugos`.`tb_cliente` (`DNI`),
  CONSTRAINT `FK_ITEM_FACTURAS`
    FOREIGN KEY (`NUMERO`)
    REFERENCES `ventas_jugos`.`tb_items_facturas` (`NUMERO`),
